...
# 28*28大小经过5*5卷积之后大小为24*24大小，5//2==2所以28*28需要padding==2即填充之后28*28——>32*32
# 在进行5*5的卷积达到了28*28与原先大小一样。
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5):  # ch_in, ch_out, shortcut, groups, expansion
        ...
        self.cv2 = Conv(c_, c2, 3, 1, g=g)  # 第一个conv模块 3*3的卷积
...
# C3模块和BottleneckCSP模块类似，但是少了一个Conv模块
class C3(nn.Module):
